...
namespace seccion7._1_metodos_otimizados
{
    internal class Program
    {
        static void Main(string[] args) //optimizaremos nuestro programa y nuestros metodos para una mejor practica 
        {
            ...
            switch (opcion)
            {
                ...
                case 3:// multiplicacion, metodo que contiene parametros 
                    ...
                    //pedimos el calor de ambos numeros
                    numAr1 = ingresarNumero("Ingresa el primer numero : ");
                    numAr2 = ingresarNumero("Ingresa el segundo numero : ");
        ...
        static int ingresarNumero (string peticion)
        {
            ...
            int numero;
            //pedimos el valor seugn corresponda
            Console.WriteLine(peticion);
            //convertir y asignar
            numero = Convert.ToInt32(Console.ReadLine());
            //devolvemos el valor de tipo entero
            return numero;

...
namespace seccion6_Tarea
{
    internal class Program
    {
        static void Main(string[] args)
        {
            //ejericicio de tarea, matrices escalonadas
            /*    
             *    Agregar el cálculo del promedio de calificaciones para cada salón en el ejercicio de matrices escalonadas.
             *    Agregar el cálculo de la menor calificación para cada salón en el ejercicio de matrices escalonadas.
             *    Agregar el cálculo de la mayor calificación para cada salón en el ejercicio de matrices escalonadas.
             *    Agregar cambios estéticos al programa para que no se vea amontonado, algunos espacios y títulos vendrían bien.
             *    *NOTA* Usar matrices para guardar los datos de cada salón por separado
             */
